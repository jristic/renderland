...
set CommonCompilerFlags=%ConfigCompilerOptions% /nologo /fp:fast /Gm- /GR- /EHa- /WX /W4 /wd4201 /FC /Z7 /D_CRT_SECURE_NO_WARNINGS /D_HAS_EXCEPTIONS=0 /I%ExternalPath% /Fo%BuildFolder%\
